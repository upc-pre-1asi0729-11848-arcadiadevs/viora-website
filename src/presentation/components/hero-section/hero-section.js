...
export function initializeHeroSection() {
    ...
    const langBtn = document.querySelector('.hero-section__language-button');
    ...
    if (langBtn) {
        ...
        // Update visual state
        i18n.subscribe((lang) => {
            langBtn.innerHTML = lang === 'en' ? '<b>EN</b> | ES' : 'EN | <b>ES</b>';
        });
        langBtn.innerHTML = i18n.currentLang === 'en' ? '<b>EN</b> | ES' : 'EN | <b>ES</b>';
    }
