...
const MEMBERS = [
    { id: 1, firstName: 'Victor',  lastName: 'Paredes',   role: 'Group ArcadiaDevs',                img: './assets/images/about/members/victor.png',    badge: './assets/logos/arcadia-dark-green.png' },
    { id: 2, firstName: 'Fabricio',lastName: 'Santi',     role: 'Group ArcadiaDevs',            img: './assets/images/about/members/fabricio.png',  badge: './assets/logos/arcadia-dark-green.png' },
    { id: 3, firstName: 'Jahat',  lastName: 'Trinidad',  role: 'Group ArcadiaDevs',     img: './assets/images/about/members/jahat.png',    badge: './assets/logos/arcadia-dark-green.png' },
    { id: 4, firstName: 'Diana',  lastName: 'Li', role: 'Group ArcadiaDevs',     img: './assets/images/about/members/diana.png',    badge: './assets/logos/arcadia-dark-green.png' },
    { id: 5, firstName: 'Piero',  lastName: 'Espada',   role: 'Group ArcadiaDevs',     img: './assets/images/about/members/piero.png',    badge: './assets/logos/arcadia-dark-green.png' },
];
...
export function initializeTeamMembersPanel(root = document) {
    ...
    roleEl.textContent      = firstMember.role;
